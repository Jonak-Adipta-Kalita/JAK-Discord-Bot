...
class Fun(commands.Cog):
    ...
    async def name_fact_generator(self, ctx: commands.Context, name: str, gender: str):
        ...
        lines = [
            ...
            f"Many ppl find {str(name)} rude and arrogant but\n {heshe} is the best and thus has many enemies.",
            ...
            str(name)
            + " has an amazing personality. Also\nfunny and fun to be around.",
            heshe
            + " is very funny, smart, and good at event the\nnew things "
            + heshe
            + " tries.",
            str(name)
            + " thinks "
            + heshe
            + "'s unattractive but every "
            + girlguy
            + "\n"
            + heshe
            + " walks past just stops and stares.",
            ...
            str(name)
            + " is a very smart, sweet, good looking\nand extremely intelligent "
            + guygirl
            + ".",
            ...
            heshe
            + " makes you smile with all your heart and you\nlove "
            + himher
            + " and never want to loose "
            + himher
            + ".",
            ...
            "Everything "
            + heshe
            + " does is so sexy and appealing,\nwhen you see "
            + himher
            + "..",
            heshe
            + " thinks only about only the lucky "
            + girlguy
            + " "
            + heshe
            + " loves and\nno one else.",
            ...
            + " holds "
            + hisher
            + " emotions and true feelings back\n"
            + heshe
            + "'s very protective of what "
            + heshe
            + " cares for.",
            "Everyone likes " + himher + ".",
            ...
            str(name)
            + "'s are extremely caring, affable, and they\nare very sensititve but tend to hide it.",
            heshe
            + "'s the kind of "
            + guygirl
            + "who's so loveable that\neveryone likes her.",
            ...
            str(name)
            + " is and achiever and the best person you turn\nto when you need a shoulder to cry on.",
            ...
            + " worth.",
            heshe
            + " is unique in every way starting from "
            + hisher
            + "\nname to "
            + hisher
            ...
            str(name) + " is a very smart and caring person.",
            heshe
            + " has a rocken model body that makes other\n"
            + guygirl
            + " jealous, but "
            + heshe
            + " is very modest.",
            ...
            heshe
            + " is really funny and sarcastic but really\nsweet and kindhearted at the same time.",
            ...
            + "\n is picky about who "
            + heshe
            + " trusts, and isn't fond of\nlarge circles.",
            girlguy
            + " really wish to have a man who is protective\nenough and secure enough.",
        ...
        ImageDraw.Draw(image).text(
            (1000 - 400, 1000 - 30), "", fill="rgb(0,0,0)", font=watermark_font
        )
